...
// checks if the UpdateVMParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateVMParams{}
...
func (o UpdateVMParams) ToMap() (map[string]interface{}, error) {
