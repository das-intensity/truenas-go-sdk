...
// checks if the ShareSMB type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShareSMB{}
...
func (o ShareSMB) ToMap() (map[string]interface{}, error) {
